...
<form class="cart single-product-add-to-cart-buttons" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt waves-effect waves-light btn btn-large yellow-bg"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
