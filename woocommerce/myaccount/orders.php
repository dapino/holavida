...
<div class="row">
	...
	<div class="bills-list center">
		

		<a id="showBills" class="btn btn-small gray-bg">Ver mis facturas</a>
		...
		<?php if ( $has_orders ) : ?>
			...
			<table class="woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table billList" id="billList">
				<thead>
					<tr>
