...
<div class="row ">
	...
	<div class="col l4 m6 s12 offset-l4 offset-m3 login-box">
		...
		<div class="row" id="customer_login">
			<div class="col m12 signin-form" id="signin-form">

				<?php endif; ?>
				<!--<h2><?php //_e( 'Login', 'woocommerce' ); ?></h2>-->

				<form method="post" class="login form-login-myaccount">
					...
					<p class="center-align">
						...
						<input type="submit" class="btn btn-small gray-bg" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
					...
					<p class="center-align lost-password">
