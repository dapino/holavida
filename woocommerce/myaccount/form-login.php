...
<div class="row" id="customer_login">
	<div class="col l6 m6 s12 offset-l3 offset-m3 signin-form" id="signin-form">
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col l6 m6 s12 offset-l3 offset-m3 signup-form" id="signup-form">
		...
		<form method="post" class="register form-login-myaccount">
			...
			<p class="center-align">
				...
				<input type="submit" class="btn" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
